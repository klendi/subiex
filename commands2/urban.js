...
Subiex.registerCommand(
      ...
      if (error) {
        ...
        if (entries.length == 1) {
          ...
          if (
            ...
            console.log('Error')
            console.log(
              'Length of entries[0].definition ' + entries[0].definition.length
            )
            console.log(
              'Length of entries[1].definition ' + entries[1].definition.length
            )
            console.log(
  ...
  ['urban', 'urban', 'urban-dict'],
  'Get urban dictionary word explanation!',
  '[]'
)
